;(function () {
...
})()(
  {
    ...
    4: [
      function (require, module, exports) {
        ...
        function createLocation(t, n, e, a) {
          var r
          "string" == typeof t
            ? ((r = parsePath(t)).state = n)
            : (void 0 === (r = _extends({}, t)).pathname && (r.pathname = ""),
              r.search
          ...
          return (
            ...
            a
              ? r.pathname
                ? "/" !== r.pathname.charAt(0) &&
                  (r.pathname = resolvePathname(r.pathname, a.pathname))
        ...
        function createBrowserHistory(t) {
          ...
          var s = window.history,
            ...
            i = void 0 === o ? 6 : o,
            f = t.basename
              ? stripTrailingSlash(addLeadingSlash(t.basename))
              : ""
          function l(t) {
            var n = t || {},
              e = n.key,
          ...
          function E(t) {
            1 === (O += t) && 1 === t
              ? (window.addEventListener(PopStateEvent, g),
                n && window.addEventListener(HashChangeEvent, P))
              : 0 === O &&
              ...
              v.confirmTransitionTo(i, "PUSH", u, function (t) {
                if (t) {
                  var n = x(i),
                    ...
                    a = i.state
                  if (c)
                    if ((s.pushState({ key: e, state: a }, null, n), h))
                      window.location.href = n
                    else {
                      var r = H.indexOf(T.location.key),
                        o = H.slice(0, r + 1)
                      o.push(i.key), (H = o), p({ action: "PUSH", location: i })
                    }
              ...
              v.confirmTransitionTo(i, o, u, function (t) {
                if (t) {
                  var n = x(i),
                    ...
                    a = i.state
                  if (c)
                    if ((s.replaceState({ key: e, state: a }, null, n), h))
                      window.location.replace(n)
                    else {
                      var r = H.indexOf(T.location.key)
                      ;-1 !== r && (H[r] = i.key), p({ action: o, location: i })
                    }
        ...
        function createHashHistory(t) {
          ...
          function L(t) {
            1 === (x += t) && 1 === t
              ? window.addEventListener(HashChangeEvent$1, g)
              : 0 === x && window.removeEventListener(HashChangeEvent$1, g)
          }
          var O = !1
          var E = {
            length: n.length,
            ...
            createHref: function (t) {
              ...
              return (
                n &&
                  n.getAttribute("href") &&
                  (e = stripHash(window.location.href)),
                e + "#" + h(s + createPath(t))
              )
            },
            push: function (t, n) {
                ...
                if (t) {
                  ...
                  if (getHashPath() !== e) {
                    ...
                    var a = y.lastIndexOf(createPath(E.location)),
                      r = y.slice(0, a + 1)
                    r.push(n), (y = r), d({ action: "PUSH", location: o })
                  } else d()
                }
              })
            },
            replace: function (t, n) {
              ...
              l.confirmTransitionTo(o, r, i, function (t) {
                if (t) {
                  ...
                  ;-1 !== a && (y[a] = n), d({ action: r, location: o })
                }
              })
            },
            go: H,
        ...
        function createMemoryHistory(t) {
          ...
          function u(t) {
            _extends(g, t),
              ...
              h.notifyListeners(g.location, g.action)
          }
          function f() {
            ...
            push: function (t, n) {
              ...
              h.confirmTransitionTo(a, "PUSH", r, function (t) {
                if (t) {
                  var n = g.index + 1,
                    e = g.entries.slice(0)
                  e.length > n ? e.splice(n, e.length - n, a) : e.push(a),
                    u({ action: "PUSH", location: a, index: n, entries: e })
                }
              })
            },
            replace: function (t, n) {
    ...
    5: [
      ...
      { "./cjs/history.js": 3, "./cjs/history.min.js": 4, _process: 11 },
    ],
    6: [
      function (require, module, exports) {
        "use strict"
    ...
    7: [
        ...
        ;(function (process, global) {
          ;(function () {
            ...
            var _inheritsLoose__default =
              /*#__PURE__*/ _interopDefaultLegacy(_inheritsLoose)
            var PropTypes__default =
              /*#__PURE__*/ _interopDefaultLegacy(PropTypes)
            ...
            function createReactContext(defaultValue, calculateChangedBits) {
              ...
              var Consumer = /*#__PURE__*/ (function (_Component2) {
                ...
                _proto2.componentWillReceiveProps =
                  function componentWillReceiveProps(nextProps) {
            ...
            var index =
              React__default["default"].createContext || createReactContext
      ...
      {
        "@babel/runtime/helpers/inheritsLoose": 1,
        _process: 11,
        "prop-types": 15,
        react: undefined,
        "tiny-warning": 30,
...
*/
    ...
    12: [
      ...
      { "./lib/ReactPropTypesSecret": 16, _process: 11 },
    ],
    13: [
      function (require, module, exports) {
        /**
    ...
    19: [
      ...
      {
        "./cjs/react-is.development.js": 17,
        "./cjs/react-is.production.min.js": 18,
        _process: 11,
      },
    ],
    20: [
      function (require, module, exports) {
        ...
        var resolveToLocation = function resolveToLocation(
          to,
          currentLocation
        ) {
        ...
        var Link = forwardRef(function (_ref2, forwardedRef) {
          var _ref2$component = _ref2.component,
            component =
              _ref2$component === void 0 ? LinkAnchor : _ref2$component,
      ...
      function (require, module, exports) {
        ...
        var BrowserRouter = (function (n) {
            function e() {
              for (
                ...
                r[o] = arguments[o]
              return (
                ((e = n.call.apply(n, [this].concat(r)) || this).history =
                  history.createBrowserHistory(e.props)),
                e
              )
            }
            return (
          ...
          HashRouter = (function (n) {
            function e() {
              ...
              return (
                ((e = n.call.apply(n, [this].concat(r)) || this).history =
                  history.createHashHistory(e.props)),
                e
              )
            }
            return (
          ...
          normalizeToLocation = function (e, t) {
            return "string" == typeof e
              ? history.createLocation(e, null, null, t)
              : e
          },
        ...
        var LinkAnchor = forwardRef(function (e, t) {
            var r = e.innerRef,
              o = e.navigate,
              n = e.onClick,
              a = _objectWithoutPropertiesLoose(e, [
                "innerRef",
                "navigate",
                "onClick",
              ]),
            ...
            return (
              (c.ref = (forwardRefShim !== forwardRef && t) || r),
              React.createElement("a", c)
            )
          }),
          Link = forwardRef(function (e, a) {
            var t = e.component,
              ...
              u = e.to,
              s = e.innerRef,
              f = _objectWithoutPropertiesLoose(e, [
                "component",
                "replace",
                "to",
                "innerRef",
            ...
            return React.createElement(
              ...
              function (t) {
                t || invariant(!1)
                var r = t.history,
                  e = normalizeToLocation(
                    resolveToLocation(u, t.location),
                    t.location
                  ),
                  o = e ? r.createHref(e) : "",
                  n = _extends({}, f, {
        ...
        var NavLink = forwardRef$1(function (e, f) {
          var t = e["aria-current"],
            ...
            x = e.to,
            g = e.innerRef,
            P = _objectWithoutPropertiesLoose(e, [
              "aria-current",
              "activeClassName",
              "activeStyle",
              "className",
          ...
          return React.createElement(
            ...
            function (e) {
              ...
              var t = m || e.location,
                ...
                n = o && o.replace(/([.+*?=^!:${}()[\]|/\\])/g, "\\$1"),
                a = n
                  ? reactRouter.matchPath(t.pathname, {
                      path: n,
                      exact: d,
                      sensitive: v,
                      strict: b,
    ...
    22: [
      ...
      {
        "./cjs/react-router-dom.js": 20,
        "./cjs/react-router-dom.min.js": 21,
        _process: 11,
      },
    ],
    23: [
      function (require, module, exports) {
        ...
        var history = require("history")
        var warning = _interopDefault(require("tiny-warning"))
        var createContext = _interopDefault(
          require("mini-create-react-context")
        )
        var invariant = _interopDefault(require("tiny-invariant"))
...

        {
          Route.propTypes = {
            ...
            component: function component(props, propName) {
              if (
                props[propName] &&
                !reactIs.isValidElementType(props[propName])
              ) {
                return new Error(
          ...
          (function (_React$Component) {
            ...
            _proto.navigateTo = function navigateTo(location, action) {
              var _this$props = this.props,
                ...
                context =
                  _this$props$context === void 0 ? {} : _this$props$context
            ...
            _proto.render = function render() {
              var _this$props2 = this.props,
                ...
                context =
                  _this$props2$context === void 0 ? {} : _this$props2$context,
          ...
          var C = function C(props) {
            ...
            return React.createElement(
              ...
              function (context) {
                ...
                return React.createElement(
                  Component,
                  _extends({}, remainingProps, context, {
    ...
    24: [
      function (require, module, exports) {
          ...
          MemoryRouter = (function (r) {
            function t() {
              for (
                ...
                n[o] = arguments[o]
              return (
                ((t = r.call.apply(r, [this].concat(n)) || this).history =
                  history.createMemoryHistory(t.props)),
                t
              )
            }
            return (
        ...
        function compilePath$1(t, e) {
          ...
          if (o[t]) return o[t]
          var r = [],
            a = { regexp: pathToRegexp(t, r, e), keys: r }
        ...
        function addBasename(t, e) {
          return t
            ? _extends({}, e, { pathname: addLeadingSlash(t) + e.pathname })
            : e
        }
        ...
        var StaticRouter = (function (r) {
            function t() {
              for (
                ...
                n[o] = arguments[o]
              return (
                ((e = r.call.apply(r, [this].concat(n)) || this).handlePush =
                  function (t) {
            ...
            return (
              (e.navigateTo = function (t, e) {
                var n = this.props,
                  ...
                  i = void 0 === a ? {} : a
                ;(i.action = e),
                  (i.location = addBasename(r, history.createLocation(t))),
                  (i.url = createURL(i.location))
              }),
              (e.render = function () {
                var t = this.props,
                  e = t.basename,
                  ...
                  a = t.location,
                  i = void 0 === a ? "/" : a,
                  c = _objectWithoutPropertiesLoose(t, [
                    "basename",
                    "context",
                    "location",
                  ]),
                ...
                return React.createElement(
                  Router,
                  _extends({}, c, { history: s, staticContext: r })
                )
              }),
              t
            )
        ...
        function withRouter(o) {
          function t(t) {
            ...
            return React.createElement(context.Consumer, null, function (t) {
              return (
                t || invariant(!1),
                React.createElement(o, _extends({}, n, t, { ref: e }))
              )
            })
          }
          var e = "withRouter(" + (o.displayName || o.name) + ")"
          return (
            (t.displayName = e), (t.WrappedComponent = o), hoistStatics(t, o)
          )
        }
        var useContext = React.useContext
        function useHistory() {
    ...
    25: [
      ...
      {
        "./cjs/react-router.js": 23,
        "./cjs/react-router.min.js": 24,
        _process: 11,
      },
    ],
    26: [
    ...
    28: [
      ...
      {
        "./cjs/resolve-pathname.js": 26,
        "./cjs/resolve-pathname.min.js": 27,
        _process: 11,
      },
    ],
    29: [
    ...
    37: [
      function (require, module, exports) {
        ...
        function valueEqual(u, r) {
          ...
          return e !== u || t !== r
            ? valueEqual(e, t)
            : Object.keys(Object.assign({}, u, r)).every(function (e) {
    ...
    38: [
      ...
      {
        "./cjs/value-equal.js": 36,
        "./cjs/value-equal.min.js": 37,
        _process: 11,
      },
    ],
    39: [
    ...
    40: [
      function (require, module, exports) {
        ...
        var _NewQuizForm = _interopRequireDefault(
          require("../components/NewQuizForm")
        )

        var _NewTopicForm = _interopRequireDefault(
          require("../components/NewTopicForm")
        )

        var _Topics = _interopRequireDefault(
          require("../features/topics/Topics")
        )

        var _Topic = _interopRequireDefault(require("../features/topics/Topic"))

        var _Quiz = _interopRequireDefault(require("../features/quizzes/Quiz"))

        var _Quizzes = _interopRequireDefault(
          require("../features/quizzes/Quizzes")
        )
          ...
          return /*#__PURE__*/ _react["default"].createElement(
              ...
              /*#__PURE__*/ _react["default"].createElement(
                ...
                /*#__PURE__*/ _react["default"].createElement(
                  ...
                  /*#__PURE__*/ _react["default"].createElement(
                    ...
                    {
                      to: _routes["default"].topicsRoute(),
                ...
                /*#__PURE__*/ _react["default"].createElement(
                  ...
                  /*#__PURE__*/ _react["default"].createElement(
                    _reactRouterDom.NavLink,
                    {
                      to: _routes["default"].quizzesRoute(),
                      activeClassName: "active",
                    },
                    "Quizzes"
                  )
                ...
                /*#__PURE__*/ _react["default"].createElement(
                  ...
                  /*#__PURE__*/ _react["default"].createElement(
                    _reactRouterDom.NavLink,
                    {
                      to: _routes["default"].newQuizRoute(),
                      activeClassName: "active",
                    },
                    "New Quiz"
                  )
            ...
            /*#__PURE__*/ _react["default"].createElement(
              ...
              /*#__PURE__*/ _react["default"].createElement(
                ...
                /*#__PURE__*/ _react["default"].createElement(QuizRoutes, null)
              )
            )
          )
        }
          ...
          return /*#__PURE__*/ _react["default"].createElement(
            ...
            /*#__PURE__*/ _react["default"].createElement(
              ...
              /*#__PURE__*/ _react["default"].createElement(
                _reactRouterDom.Route,
                {
                  path: "".concat(match.path, "/new"),
                },
                /*#__PURE__*/ _react["default"].createElement(
                  _NewTopicForm["default"],
                  null
                )
              ),
              /*#__PURE__*/ _react["default"].createElement(
      ...
      {
        "../components/NewQuizForm": 43,
        "../components/NewTopicForm": 44,
        "../features/quizzes/Quiz": 47,
        "../features/quizzes/Quizzes": 48,
        "../features/topics/Topic": 49,
        "../features/topics/Topics": 50,
        "./routes": 41,
        react: undefined,
        "react-router-dom": 22,
      },
    ...
    41: [
      function (require, module, exports) {
        ...
        var ROUTES = {
          newQuizRoute: function newQuizRoute() {
            return "/quizzes/new"
          },
          quizRoute: function quizRoute(id) {
            return "/quizzes/".concat(id)
          },
          quizzesRoute: function quizzesRoute() {
            return "/quizzes"
          },
          newTopicRoute: function newTopicRoute() {
            return "/topics/new"
          },
          topicRoute: function topicRoute(id) {
            return "/topics/".concat(id)
          },
          topicsRoute: function topicsRoute() {
            return "/topics"
          },
        }
        var _default = ROUTES
      ...
      function (require, module, exports) {
        ...
        function NewQuizForm() {
          ...
          var handleSubmit = function handleSubmit(e) {
            ...
            var cardIds = [] // create the new cards here and add each card's id to cardIds
            // create the new quiz here

            history.push(_routes["default"].quizzesRoute())
          }

          var addCardInputs = function addCardInputs(e) {
            e.preventDefault()
            setCards(
              cards.concat({
                front: "",
          ...
          var removeCard = function removeCard(e, index) {
            e.preventDefault()
            setCards(
          ...
          var updateCardState = function updateCardState(index, side, value) {
            ...
            /*#__PURE__*/ _react["default"].createElement(
              ...
              /*#__PURE__*/ _react["default"].createElement(
                "select",
                {
                  id: "quiz-topic",
                  onChange: function onChange(e) {
                    return setTopicId(e.currentTarget.value)
                  },
                  placeholder: "Topic",
                },
                /*#__PURE__*/ _react["default"].createElement(
                ...
                Object.values(topics).map(function (topic) {
                  return /*#__PURE__*/ _react["default"].createElement(
                    "option",
                    {
                      key: topic.id,
      ...
      function (require, module, exports) {
        ...
        function NewTopicForm() {
          ...
          var handleSubmit = function handleSubmit(e) {
            ...
            history.push(_routes["default"].topicsRoute())
          }
            ...
            /*#__PURE__*/ _react["default"].createElement(
              ...
              /*#__PURE__*/ _react["default"].createElement(
                ...
                /*#__PURE__*/ _react["default"].createElement(
                  ...
                  {
                    onChange: function onChange(e) {
                      return setIcon(e.currentTarget.value)
                    },
                    required: true,
                  ...
                  _icons.ALL_ICONS.map(function (_ref) {
                    var name = _ref.name,
                      url = _ref.url
                    return /*#__PURE__*/ _react["default"].createElement(
                      "option",
    ...
    45: [
      function (require, module, exports) {
        ...
        exports.ALL_ICONS =
          exports.TREE_ICON =
          exports.SUN_ICON =
          exports.STATISTICS_ICON =
          exports.SPADE_ICON =
          exports.SHUTTLECOCK_ICON =
          exports.NEST_ICON =
          exports.MEDICINE_ICON =
          exports.LEAVES_ICON =
          exports.LADYBUG_ICON =
          exports.INTERNET_ICON =
          exports.HAT_ICON =
          exports.HAND_DRILL_ICON =
          exports.GRILL_ICON =
          exports.FENCE_ICON =
          exports.DATA_FLOW_ICON =
          exports.CRAYONS_ICON =
          exports.CLOVER_ICON =
          exports.CALENDAR_ICON =
          exports.BIRD_ICON =
          exports.BALLOON_ICON =
          exports.BOOK_ICON =
            void 0
        var BOOK_ICON =
          "https://static-assets.codecademy.com/skillpaths/react-redux/redux-quiz-app/book.svg"
        exports.BOOK_ICON = BOOK_ICON
        var BALLOON_ICON =
          "https://static-assets.codecademy.com/skillpaths/react-redux/redux-quiz-app/balloon.svg"
        exports.BALLOON_ICON = BALLOON_ICON
        var BIRD_ICON =
          "https://static-assets.codecademy.com/skillpaths/react-redux/redux-quiz-app/bird.svg"
        exports.BIRD_ICON = BIRD_ICON
        var CALENDAR_ICON =
    ...
    46: [
      function (require, module, exports) {
        ...
        function Card(_ref) {
          var id = _ref.id
          var cards = {} // replace this with a call to your selector to get all the cards in state
      ...
      { react: undefined, "react-router-dom": 22 },
    ],
    47: [
      function (require, module, exports) {
        "use strict"
        ...
        function Topic() {
          var quizzes = {} // replace this with a call to your selector to get all the quizzes in state
    ...
    48: [
        ...
        function Quizzes() {
          ...
          return /*#__PURE__*/ _react["default"].createElement(
            ...
            /*#__PURE__*/ _react["default"].createElement(
              "ul",
              {
                className: "quizzes-list",
              },
              Object.values(quizzes).map(function (quiz) {
                return /*#__PURE__*/ _react["default"].createElement(
                  _reactRouterDom.Link,
                  {
                    key: quiz.id,
                    to: _routes["default"].quizRoute(quiz.id),
                  },
                  /*#__PURE__*/ _react["default"].createElement(
                    "li",
                    {
      ...
      { "../../app/routes": 41, react: undefined, "react-router-dom": 22 },
    ],
    49: [
      function (require, module, exports) {
        "use strict"
        ...
        function Topic() {
          var topics = {} // replace this with a call to your selector to select all the topics in state

          var quizzes = {} // replace this with a call to your selector to select all the quizzes in state

          var _useParams = (0, _reactRouterDom.useParams)(),
            topicId = _useParams.topicId

          var topic = topics[topicId]
          var quizzesForTopic = topic.quizIds.map(function (quizId) {
          ...
          return /*#__PURE__*/ _react["default"].createElement(
            ...
            /*#__PURE__*/ _react["default"].createElement(
              ...
              quizzesForTopic.map(function (quiz) {
                return /*#__PURE__*/ _react["default"].createElement(
                  "li",
                  {
                    className: "quiz",
      ...
      function (require, module, exports) {
        ...
        function Topics() {
          ...
          return /*#__PURE__*/ _react["default"].createElement(
            ...
            /*#__PURE__*/ _react["default"].createElement("h1", null, "Topics"),
            /*#__PURE__*/ _react["default"].createElement(
              "ul",
              {
              ...
              Object.values(topics).map(function (topic) {
                return /*#__PURE__*/ _react["default"].createElement(
                  ...
                  /*#__PURE__*/ _react["default"].createElement(
                    _reactRouterDom.Link,
                    {
                      to: _routes["default"].topicRoute(topic.id),
            ...
            /*#__PURE__*/ _react["default"].createElement(
              _reactRouterDom.Link,
              {
                to: _routes["default"].newTopicRoute(),
